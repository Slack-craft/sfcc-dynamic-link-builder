...
import MatchesPreviewPanel from "@/components/catalogue/MatchesPreviewPanel"
...
import PreviewUrlBar from "@/components/catalogue/PreviewUrlBar"
import {
  Check,
  ChevronDown,
  List,
...
import useTileMatches from "@/hooks/useTileMatches"
    ...
    <Card className="lg:col-span-2 flex flex-col">
      <CardHeader>
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-2">
            <PreviewUrlBar
              previewRestValue={previewRestValue}
              onPreviewRestChange={handlePreviewRestChange}
              mode={activeLinkMode}
              onChangeMode={(nextMode) => onActiveLinkModeChange?.(nextMode)}
